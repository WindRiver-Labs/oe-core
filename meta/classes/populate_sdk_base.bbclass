...
def populate_sdk_common(d):
    ...
    excl_pkgs = (d.getVar("PACKAGE_EXCLUDE", True) or "").split()
    inst_pkgs = (d.getVar("PACKAGE_INSTALL", True) or "").split()
    inst_attempt_pkgs = (d.getVar("PACKAGE_INSTALL_ATTEMPTONLY", True) or "").split()
