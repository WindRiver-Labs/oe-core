python multilib_virtclass_handler () {
    ...
    blacklist = e.data.getVarFlag('PNBLACKLIST', e.data.getVar('PN', True), True)
    if blacklist:
        pn_new = variant + "-" + e.data.getVar('PN', True)
        if not e.data.getVarFlag('PNBLACKLIST', pn_new, True):
