...
LICENSE_${PN}-iwlwifi-Qu-c0-hr  = "Firmware-iwlwifi_firmware"
...
FILES_${PN}-iwlwifi-Qu-c0-hr = "${nonarch_base_libdir}/firmware/iwlwifi-Qu-c0-hr-*.ucode"
...
RDEPENDS_${PN}-iwlwifi-Qu-c0-hr  = "${PN}-iwlwifi-license"
