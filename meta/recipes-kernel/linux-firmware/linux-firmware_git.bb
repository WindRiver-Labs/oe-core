...
LIC_FILES_CHKSUM = "\
    ...
    file://WHENCE;md5=d40b0489b4ec57a634d918a50a9d1ee0 \
"
...
SRCREV = "2a713be25a44bd6cec90d8affc54b246a2ca9c7b"
PE = "1"
PV = "0.0+git${SRCPV}"
...
SRC_URI += "file://iwlwifi-8000C-19.ucode;name=iwlwifi-19"
...
PACKAGES =+ "${PN}-ralink-license ${PN}-ralink \
             ...
             ${PN}-marvell-license ${PN}-sd8686 ${PN}-sd8688 ${PN}-sd8787 ${PN}-sd8797 ${PN}-pcie8897 ${PN}-usb8897 \
